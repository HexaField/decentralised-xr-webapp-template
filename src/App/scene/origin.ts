    ...
    easyLine(
      {
        points: [
          new THREE.Vector3(),
          new THREE.Vector3(args.distance || 1, 0, 0),
        ],
      },
      { color: 0xff0000 },
    ),
    ...
    easyLine(
      {
        points: [
          new THREE.Vector3(),
          new THREE.Vector3(0, args.distance || 1, 0),
        ],
      },
      { color: 0x00ff00 },
    ),
    ...
    easyLine(
      {
        points: [
          new THREE.Vector3(),
          new THREE.Vector3(0, 0, args.distance || 1),
        ],
      },
      { color: 0x0000ff },
    ),
...
export function easyLine(args: any = {}, matArgs: any = {}) {
  return new THREE.Line(
    new THREE.BufferGeometry().setFromPoints(args.points),
    args.material || new THREE.LineBasicMaterial(matArgs),
  );
}
...
export function easyBox(args: any = {}, matArgs: any = {}) {
  return new THREE.Mesh(
    ...
    args.material || easyMaterial(matArgs),
  );
}

export function easyPlane(args: any = {}, matArgs: any = {}) {
  return new THREE.Mesh(
    new THREE.PlaneGeometry(args.width, args.height),
    args.material || easyMaterial(matArgs),
  );
}
